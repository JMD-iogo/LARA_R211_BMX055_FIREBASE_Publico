        ...
        with serial.Serial(porta, baudrate, timeout=1) as ser:
            ...
            while tempo_valido < tempo_aquisicao:
                ...
                if linha:
                    ...
                    if len(partes) % 2 == 0 and "Erro ao encontrar o endereco i2c" not in partes:
...
capturar_dados_serial("COM8", 115200, "dados.xlsx", 60*2)
#recomendo comecar  a correr e depois dos prints iniciais passrem parar o programa e voltar a correr, assim nao se corre o risco dos 
#dados ficarem reescritos no excel
